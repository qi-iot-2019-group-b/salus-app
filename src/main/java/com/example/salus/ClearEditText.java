...
public class ClearEditText extends AppCompatEditText implements TextWatcher, View.OnTouchListener, View.OnFocusChangeListener {
    ...
    public ClearEditText(final Context ctx) {
        super(ctx);
        init();
    }

    public ClearEditText(final Context ctx, final AttributeSet attrs) {
        super(ctx, attrs);
        init();
    }

    public ClearEditText(final Context ctx, final AttributeSet attrs, final int defStyleAttr) {
